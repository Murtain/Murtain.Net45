...
namespace Murtain.Domain.UnitOfWork
{
    ...
    public abstract class UnitOfWorkBase : IUnitOfWork
    {
        ...
        /// </summary>
        protected IUnitOfWorkDefaultOptionsConfiguration DefaultOptions { get; private set; }
        ...
        /// </summary>
        public IAppSession AbpSession { private get; set; }
        ...
        /// Constructor.
        /// </summary>
        protected UnitOfWorkBase(IUnitOfWorkDefaultOptionsConfiguration defaultOptions)
        {
            DefaultOptions = defaultOptions;

            Id = Guid.NewGuid().ToString("N");
            _filters = defaultOptions.Filters.ToList();
            AbpSession = NullAppSession.Instance;
        }
