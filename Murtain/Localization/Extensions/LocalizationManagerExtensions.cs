...
namespace Murtain.Localization.Extensions
{
    public static class LocalizationManagerExtensions
    {
        ...
        public static string GetString(this ILocalizationManager localizationManager, LocalizationString localizableString)
        {
        ...
        /// </summary>
        /// <returns>Localized string</returns>
        public static string GetString(this ILocalizationManager localizationManager, LocalizationString localizableString, CultureInfo culture)
        {
